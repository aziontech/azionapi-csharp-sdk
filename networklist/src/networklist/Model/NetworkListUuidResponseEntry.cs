...
namespace networklist.Model
{
    ...
    public partial class NetworkListUuidResponseEntry : IEquatable<NetworkListUuidResponseEntry>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as NetworkListUuidResponseEntry);
        }

        /// <summary>
        /// Returns true if NetworkListUuidResponseEntry instances are equal
        /// </summary>
        /// <param name="input">Instance of NetworkListUuidResponseEntry to be compared</param>
        /// <returns>Boolean</returns>
