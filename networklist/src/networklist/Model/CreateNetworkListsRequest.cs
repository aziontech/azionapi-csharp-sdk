...
namespace networklist.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateNetworkListsRequest")]
    public partial class CreateNetworkListsRequest : IEquatable<CreateNetworkListsRequest>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CreateNetworkListsRequest);
        }

        /// <summary>
        /// Returns true if CreateNetworkListsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateNetworkListsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateNetworkListsRequest input)
        {
            if (input == null)
            {
                return false;
