...
namespace networklist.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateNetworkListsRequest")]
    public partial class UpdateNetworkListsRequest : IEquatable<UpdateNetworkListsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateNetworkListsRequest" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        /// <param name="itemsValues">itemsValues.</param>
        /// <param name="listType">listType.</param>
        public UpdateNetworkListsRequest(string name = default(string), List<string> itemsValues = default(List<string>), string listType = default(string))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as UpdateNetworkListsRequest);
        }

        /// <summary>
        /// Returns true if UpdateNetworkListsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateNetworkListsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateNetworkListsRequest input)
        {
            if (input == null)
            {
                return false;
