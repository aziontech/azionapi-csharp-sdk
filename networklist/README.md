# networklist - the C# library for the Network Lists API
...
```
nuget pack -Build -OutputDirectory out networklist.csproj
```
...
## Documentation for Models
 ...
 - [Model.CreateNetworkListsRequest](docs/CreateNetworkListsRequest.md)
 ...
 - [Model.NetworkListUuidResponseEntryInt](docs/NetworkListUuidResponseEntryInt.md)
 - [Model.NetworkListUuidResponseEntryString](docs/NetworkListUuidResponseEntryString.md)
