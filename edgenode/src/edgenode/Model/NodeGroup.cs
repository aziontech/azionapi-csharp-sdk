...
namespace edgenode.Model
{
    ...
    public partial class NodeGroup : IEquatable<NodeGroup>, IValidatableObject
    {
        ...
        public NodeGroup(long id = default(long), string name = default(string))
        {
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for NodeGroup and cannot be null");
            }
            this.Name = name;
        }
