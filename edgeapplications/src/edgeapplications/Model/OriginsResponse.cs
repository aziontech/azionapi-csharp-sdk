...
namespace edgeapplications.Model
{
    ...
    /// OriginsResponse
    /// </summary>
    [DataContract(Name = "OriginsResponse")]
    public partial class OriginsResponse : IEquatable<OriginsResponse>, IValidatableObject
    {
        ...
        public OriginsResponse(long count = default(long), long totalPages = default(long), long schemaVersion = default(long), OriginsResponseLinks links = default(OriginsResponseLinks), List<OriginsResultResponse> results = default(List<OriginsResultResponse>))
        {
            this.Count = count;
            ...
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for OriginsResponse and cannot be null");
            }
            this.Links = links;
            // to ensure "results" is required (not null)
            if (results == null)
            {
                throw new ArgumentNullException("results is a required property for OriginsResponse and cannot be null");
            }
