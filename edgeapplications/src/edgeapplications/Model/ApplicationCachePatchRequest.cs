...
namespace edgeapplications.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApplicationCachePatchRequest")]
    public partial class ApplicationCachePatchRequest : IEquatable<ApplicationCachePatchRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ApplicationCachePatchRequest);
        }

        /// <summary>
        /// Returns true if ApplicationCachePatchRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationCachePatchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationCachePatchRequest input)
        {
            if (input == null)
            {
                return false;
