...
namespace edgeapplications.Model
{
    ...
    /// PatchOriginsRequest
    /// </summary>
    [DataContract(Name = "PatchOriginsRequest")]
    public partial class PatchOriginsRequest : IEquatable<PatchOriginsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchOriginsRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PatchOriginsRequest);
        }

        /// <summary>
        /// Returns true if PatchOriginsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchOriginsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchOriginsRequest input)
        {
            if (input == null)
            {
                return false;
