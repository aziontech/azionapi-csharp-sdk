...
namespace edgeapplications.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateOriginsRequest")]
    public partial class CreateOriginsRequest : IEquatable<CreateOriginsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOriginsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateOriginsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOriginsRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CreateOriginsRequest);
        }

        /// <summary>
        /// Returns true if CreateOriginsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateOriginsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateOriginsRequest input)
        {
            if (input == null)
            {
                return false;
