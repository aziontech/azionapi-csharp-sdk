...
namespace edgeapplications.Model
{
    ...
    public partial class DeviceGroupsIdResponse : IEquatable<DeviceGroupsIdResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DeviceGroupsIdResponse);
        }

        /// <summary>
        /// Returns true if DeviceGroupsIdResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceGroupsIdResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceGroupsIdResponse input)
        {
            if (input == null)
            {
                return false;
