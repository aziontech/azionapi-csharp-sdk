...
namespace edgeapplications.Model
{
    ...
    public partial class ApplicationCacheResponseDetails : IEquatable<ApplicationCacheResponseDetails>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ApplicationCacheResponseDetails);
        }

        /// <summary>
        /// Returns true if ApplicationCacheResponseDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationCacheResponseDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationCacheResponseDetails input)
        {
            if (input == null)
            {
                return false;
