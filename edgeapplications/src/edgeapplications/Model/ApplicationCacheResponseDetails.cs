...
namespace edgeapplications.Model
{
    ...
    public partial class ApplicationCacheResponseDetails : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ApplicationCacheResponseDetails(long id, string name, string browserCacheSettings, long browserCacheSettingsMaximumTtl, string cdnCacheSettings, long cdnCacheSettingsMaximumTtl, string cacheByQueryString, bool enableQueryStringSort, string cacheByCookies, bool enableCachingForPost, bool l2CachingEnabled, List<string>? queryStringFields = default, List<string>? cookieNames = default, Option<string?> adaptiveDeliveryAction = default, Option<List<int>?> deviceGroup = default, Option<bool?> enableCachingForOptions = default, Option<bool?> isSliceConfigurationEnabled = default, Option<bool?> isSliceEdgeCachingEnabled = default, Option<bool?> isSliceL2CachingEnabled = default, Option<long?> sliceConfigurationRange = default, Option<bool?> enableStaleCache = default, Option<string?> l2Region = default)
        {
            Id = id;
            Name = name;
    ...
    /// <summary>
    /// A Json converter for type <see cref="ApplicationCacheResponseDetails" />
    /// </summary>
    public class ApplicationCacheResponseDetailsJsonConverter : JsonConverter<ApplicationCacheResponseDetails>
    {
        /// <summary>
        /// Deserializes json to <see cref="ApplicationCacheResponseDetails" />
        /// </summary>
        ...
        public override ApplicationCacheResponseDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!id.IsSet)
                throw new ArgumentException("Property is required for class ApplicationCacheResponseDetails.", nameof(id));

            if (!name.IsSet)
                throw new ArgumentException("Property is required for class ApplicationCacheResponseDetails.", nameof(name));

            if (!browserCacheSettings.IsSet)
                throw new ArgumentException("Property is required for class ApplicationCacheResponseDetails.", nameof(browserCacheSettings));

            if (!browserCacheSettingsMaximumTtl.IsSet)
                throw new ArgumentException("Property is required for class ApplicationCacheResponseDetails.", nameof(browserCacheSettingsMaximumTtl));

            if (!cdnCacheSettings.IsSet)
                throw new ArgumentException("Property is required for class ApplicationCacheResponseDetails.", nameof(cdnCacheSettings));

            if (!cdnCacheSettingsMaximumTtl.IsSet)
                throw new ArgumentException("Property is required for class ApplicationCacheResponseDetails.", nameof(cdnCacheSettingsMaximumTtl));

            if (!cacheByQueryString.IsSet)
                throw new ArgumentException("Property is required for class ApplicationCacheResponseDetails.", nameof(cacheByQueryString));

            if (!enableQueryStringSort.IsSet)
                throw new ArgumentException("Property is required for class ApplicationCacheResponseDetails.", nameof(enableQueryStringSort));

            if (!cacheByCookies.IsSet)
                throw new ArgumentException("Property is required for class ApplicationCacheResponseDetails.", nameof(cacheByCookies));

            if (!enableCachingForPost.IsSet)
                throw new ArgumentException("Property is required for class ApplicationCacheResponseDetails.", nameof(enableCachingForPost));

            if (!l2CachingEnabled.IsSet)
                throw new ArgumentException("Property is required for class ApplicationCacheResponseDetails.", nameof(l2CachingEnabled));

            if (!queryStringFields.IsSet)
                throw new ArgumentException("Property is required for class ApplicationCacheResponseDetails.", nameof(queryStringFields));

            if (!cookieNames.IsSet)
                throw new ArgumentException("Property is required for class ApplicationCacheResponseDetails.", nameof(cookieNames));

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class ApplicationCacheResponseDetails.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class ApplicationCacheResponseDetails.");

            if (browserCacheSettings.IsSet && browserCacheSettings.Value == null)
                throw new ArgumentNullException(nameof(browserCacheSettings), "Property is not nullable for class ApplicationCacheResponseDetails.");

            if (browserCacheSettingsMaximumTtl.IsSet && browserCacheSettingsMaximumTtl.Value == null)
                throw new ArgumentNullException(nameof(browserCacheSettingsMaximumTtl), "Property is not nullable for class ApplicationCacheResponseDetails.");

            if (cdnCacheSettings.IsSet && cdnCacheSettings.Value == null)
                throw new ArgumentNullException(nameof(cdnCacheSettings), "Property is not nullable for class ApplicationCacheResponseDetails.");

            if (cdnCacheSettingsMaximumTtl.IsSet && cdnCacheSettingsMaximumTtl.Value == null)
                throw new ArgumentNullException(nameof(cdnCacheSettingsMaximumTtl), "Property is not nullable for class ApplicationCacheResponseDetails.");

            if (cacheByQueryString.IsSet && cacheByQueryString.Value == null)
                throw new ArgumentNullException(nameof(cacheByQueryString), "Property is not nullable for class ApplicationCacheResponseDetails.");

            if (enableQueryStringSort.IsSet && enableQueryStringSort.Value == null)
                throw new ArgumentNullException(nameof(enableQueryStringSort), "Property is not nullable for class ApplicationCacheResponseDetails.");

            if (cacheByCookies.IsSet && cacheByCookies.Value == null)
                throw new ArgumentNullException(nameof(cacheByCookies), "Property is not nullable for class ApplicationCacheResponseDetails.");

            if (enableCachingForPost.IsSet && enableCachingForPost.Value == null)
                throw new ArgumentNullException(nameof(enableCachingForPost), "Property is not nullable for class ApplicationCacheResponseDetails.");

            if (l2CachingEnabled.IsSet && l2CachingEnabled.Value == null)
                throw new ArgumentNullException(nameof(l2CachingEnabled), "Property is not nullable for class ApplicationCacheResponseDetails.");

            if (adaptiveDeliveryAction.IsSet && adaptiveDeliveryAction.Value == null)
                throw new ArgumentNullException(nameof(adaptiveDeliveryAction), "Property is not nullable for class ApplicationCacheResponseDetails.");

            if (deviceGroup.IsSet && deviceGroup.Value == null)
                throw new ArgumentNullException(nameof(deviceGroup), "Property is not nullable for class ApplicationCacheResponseDetails.");

            if (enableCachingForOptions.IsSet && enableCachingForOptions.Value == null)
                throw new ArgumentNullException(nameof(enableCachingForOptions), "Property is not nullable for class ApplicationCacheResponseDetails.");

            if (isSliceConfigurationEnabled.IsSet && isSliceConfigurationEnabled.Value == null)
                throw new ArgumentNullException(nameof(isSliceConfigurationEnabled), "Property is not nullable for class ApplicationCacheResponseDetails.");

            if (isSliceEdgeCachingEnabled.IsSet && isSliceEdgeCachingEnabled.Value == null)
                throw new ArgumentNullException(nameof(isSliceEdgeCachingEnabled), "Property is not nullable for class ApplicationCacheResponseDetails.");

            if (isSliceL2CachingEnabled.IsSet && isSliceL2CachingEnabled.Value == null)
                throw new ArgumentNullException(nameof(isSliceL2CachingEnabled), "Property is not nullable for class ApplicationCacheResponseDetails.");

            if (sliceConfigurationRange.IsSet && sliceConfigurationRange.Value == null)
                throw new ArgumentNullException(nameof(sliceConfigurationRange), "Property is not nullable for class ApplicationCacheResponseDetails.");

            if (enableStaleCache.IsSet && enableStaleCache.Value == null)
                throw new ArgumentNullException(nameof(enableStaleCache), "Property is not nullable for class ApplicationCacheResponseDetails.");

            return new ApplicationCacheResponseDetails(id.Value!.Value!, name.Value!, browserCacheSettings.Value!, browserCacheSettingsMaximumTtl.Value!.Value!, cdnCacheSettings.Value!, cdnCacheSettingsMaximumTtl.Value!.Value!, cacheByQueryString.Value!, enableQueryStringSort.Value!.Value!, cacheByCookies.Value!, enableCachingForPost.Value!.Value!, l2CachingEnabled.Value!.Value!, queryStringFields.Value!, cookieNames.Value!, adaptiveDeliveryAction, deviceGroup, enableCachingForOptions, isSliceConfigurationEnabled, isSliceEdgeCachingEnabled, isSliceL2CachingEnabled, sliceConfigurationRange, enableStaleCache, l2Region);
        }

        /// <summary>
        /// Serializes a <see cref="ApplicationCacheResponseDetails" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="applicationCacheResponseDetails"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ApplicationCacheResponseDetails applicationCacheResponseDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, applicationCacheResponseDetails, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ApplicationCacheResponseDetails" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="applicationCacheResponseDetails"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ApplicationCacheResponseDetails applicationCacheResponseDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            if (applicationCacheResponseDetails.Name == null)
                throw new ArgumentNullException(nameof(applicationCacheResponseDetails.Name), "Property is required for class ApplicationCacheResponseDetails.");

            if (applicationCacheResponseDetails.BrowserCacheSettings == null)
                throw new ArgumentNullException(nameof(applicationCacheResponseDetails.BrowserCacheSettings), "Property is required for class ApplicationCacheResponseDetails.");

            if (applicationCacheResponseDetails.CdnCacheSettings == null)
                throw new ArgumentNullException(nameof(applicationCacheResponseDetails.CdnCacheSettings), "Property is required for class ApplicationCacheResponseDetails.");

            if (applicationCacheResponseDetails.CacheByQueryString == null)
                throw new ArgumentNullException(nameof(applicationCacheResponseDetails.CacheByQueryString), "Property is required for class ApplicationCacheResponseDetails.");

            if (applicationCacheResponseDetails.CacheByCookies == null)
                throw new ArgumentNullException(nameof(applicationCacheResponseDetails.CacheByCookies), "Property is required for class ApplicationCacheResponseDetails.");

            if (applicationCacheResponseDetails.AdaptiveDeliveryActionOption.IsSet && applicationCacheResponseDetails.AdaptiveDeliveryAction == null)
                throw new ArgumentNullException(nameof(applicationCacheResponseDetails.AdaptiveDeliveryAction), "Property is required for class ApplicationCacheResponseDetails.");

            if (applicationCacheResponseDetails.DeviceGroupOption.IsSet && applicationCacheResponseDetails.DeviceGroup == null)
                throw new ArgumentNullException(nameof(applicationCacheResponseDetails.DeviceGroup), "Property is required for class ApplicationCacheResponseDetails.");

            writer.WriteNumber("id", applicationCacheResponseDetails.Id);

            writer.WriteString("name", applicationCacheResponseDetails.Name);

            writer.WriteString("browser_cache_settings", applicationCacheResponseDetails.BrowserCacheSettings);

            writer.WriteNumber("browser_cache_settings_maximum_ttl", applicationCacheResponseDetails.BrowserCacheSettingsMaximumTtl);

            writer.WriteString("cdn_cache_settings", applicationCacheResponseDetails.CdnCacheSettings);

            writer.WriteNumber("cdn_cache_settings_maximum_ttl", applicationCacheResponseDetails.CdnCacheSettingsMaximumTtl);

            writer.WriteString("cache_by_query_string", applicationCacheResponseDetails.CacheByQueryString);

            writer.WriteBoolean("enable_query_string_sort", applicationCacheResponseDetails.EnableQueryStringSort);

            writer.WriteString("cache_by_cookies", applicationCacheResponseDetails.CacheByCookies);

            writer.WriteBoolean("enable_caching_for_post", applicationCacheResponseDetails.EnableCachingForPost);

            writer.WriteBoolean("l2_caching_enabled", applicationCacheResponseDetails.L2CachingEnabled);

            if (applicationCacheResponseDetails.QueryStringFields != null)
            {
                writer.WritePropertyName("query_string_fields");
                JsonSerializer.Serialize(writer, applicationCacheResponseDetails.QueryStringFields, jsonSerializerOptions);
            }
            else
                writer.WriteNull("query_string_fields");
            if (applicationCacheResponseDetails.CookieNames != null)
            {
                writer.WritePropertyName("cookie_names");
                JsonSerializer.Serialize(writer, applicationCacheResponseDetails.CookieNames, jsonSerializerOptions);
            }
            else
                writer.WriteNull("cookie_names");
            if (applicationCacheResponseDetails.AdaptiveDeliveryActionOption.IsSet)
                writer.WriteString("adaptive_delivery_action", applicationCacheResponseDetails.AdaptiveDeliveryAction);

            if (applicationCacheResponseDetails.DeviceGroupOption.IsSet)
            {
                writer.WritePropertyName("device_group");
                JsonSerializer.Serialize(writer, applicationCacheResponseDetails.DeviceGroup, jsonSerializerOptions);
            }
            if (applicationCacheResponseDetails.EnableCachingForOptionsOption.IsSet)
                writer.WriteBoolean("enable_caching_for_options", applicationCacheResponseDetails.EnableCachingForOptionsOption.Value!.Value);

            if (applicationCacheResponseDetails.IsSliceConfigurationEnabledOption.IsSet)
                writer.WriteBoolean("is_slice_configuration_enabled", applicationCacheResponseDetails.IsSliceConfigurationEnabledOption.Value!.Value);

            if (applicationCacheResponseDetails.IsSliceEdgeCachingEnabledOption.IsSet)
                writer.WriteBoolean("is_slice_edge_caching_enabled", applicationCacheResponseDetails.IsSliceEdgeCachingEnabledOption.Value!.Value);

            if (applicationCacheResponseDetails.IsSliceL2CachingEnabledOption.IsSet)
                writer.WriteBoolean("is_slice_l2_caching_enabled", applicationCacheResponseDetails.IsSliceL2CachingEnabledOption.Value!.Value);

            if (applicationCacheResponseDetails.SliceConfigurationRangeOption.IsSet)
                writer.WriteNumber("slice_configuration_range", applicationCacheResponseDetails.SliceConfigurationRangeOption.Value!.Value);

            if (applicationCacheResponseDetails.EnableStaleCacheOption.IsSet)
                writer.WriteBoolean("enable_stale_cache", applicationCacheResponseDetails.EnableStaleCacheOption.Value!.Value);

            if (applicationCacheResponseDetails.L2RegionOption.IsSet)
                if (applicationCacheResponseDetails.L2RegionOption.Value != null)
                    writer.WriteString("l2_region", applicationCacheResponseDetails.L2Region);
                else
                    writer.WriteNull("l2_region");
        }
    }
}
