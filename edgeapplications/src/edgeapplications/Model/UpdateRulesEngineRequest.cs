...
namespace edgeapplications.Model
{
    ...
    public partial class UpdateRulesEngineRequest : IEquatable<UpdateRulesEngineRequest>, IValidatableObject
    {
        ...
        public UpdateRulesEngineRequest(string name = default(string), List<List<RulesEngineCriteria>> criteria = default(List<List<RulesEngineCriteria>>), List<RulesEngineBehavior> behaviors = default(List<RulesEngineBehavior>))
        {
