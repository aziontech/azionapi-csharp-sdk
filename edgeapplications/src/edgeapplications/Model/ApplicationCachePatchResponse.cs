...
namespace edgeapplications.Model
{
    ...
    public partial class ApplicationCachePatchResponse : IEquatable<ApplicationCachePatchResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ApplicationCachePatchResponse);
        }

        /// <summary>
        /// Returns true if ApplicationCachePatchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationCachePatchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationCachePatchResponse input)
        {
            if (input == null)
            {
                return false;
