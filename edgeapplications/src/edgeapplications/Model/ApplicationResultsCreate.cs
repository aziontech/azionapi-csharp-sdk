...
namespace edgeapplications.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApplicationResultsCreate")]
    public partial class ApplicationResultsCreate : IEquatable<ApplicationResultsCreate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationResultsCreate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ApplicationResultsCreate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationResultsCreate" /> class.
        /// </summary>
        ...
        public ApplicationResultsCreate(long id = default(long), string name = default(string), bool active = default(bool), string deliveryProtocol = default(string), Object httpPort = default(Object), Object httpsPort = default(Object), string minimumTlsVersion = default(string), bool applicationAcceleration = default(bool), bool caching = default(bool), bool deviceDetection = default(bool), bool edgeFirewall = default(bool), bool edgeFunctions = default(bool), bool imageOptimization = default(bool), bool loadBalancer = default(bool), bool rawLogs = default(bool), bool webApplicationFirewall = default(bool))
        {
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ApplicationResultsCreate and cannot be null");
            }
            this.Name = name;
            this.Active = active;
            ...
            {
                throw new ArgumentNullException("deliveryProtocol is a required property for ApplicationResultsCreate and cannot be null");
            }
            this.DeliveryProtocol = deliveryProtocol;
            // to ensure "httpPort" is required (not null)
            if (httpPort == null)
            {
                throw new ArgumentNullException("httpPort is a required property for ApplicationResultsCreate and cannot be null");
            }
            this.HttpPort = httpPort;
            // to ensure "httpsPort" is required (not null)
            if (httpsPort == null)
            {
                throw new ArgumentNullException("httpsPort is a required property for ApplicationResultsCreate and cannot be null");
            }
            this.HttpsPort = httpsPort;
            // to ensure "minimumTlsVersion" is required (not null)
            if (minimumTlsVersion == null)
            {
                throw new ArgumentNullException("minimumTlsVersion is a required property for ApplicationResultsCreate and cannot be null");
            }
        ...
        {
            return this.Equals(input as ApplicationResultsCreate);
        }

        /// <summary>
        /// Returns true if ApplicationResultsCreate instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationResultsCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationResultsCreate input)
        {
            if (input == null)
            {
                return false;
