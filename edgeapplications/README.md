...
```
nuget pack -Build -OutputDirectory out edgeapplications.csproj
```
...
## Documentation for Models
 ...
 - [Model.RulesEngineBehaviorEntry](docs/RulesEngineBehaviorEntry.md)
 - [Model.RulesEngineBehaviorObject](docs/RulesEngineBehaviorObject.md)
 - [Model.RulesEngineBehaviorObjectTarget](docs/RulesEngineBehaviorObjectTarget.md)
 - [Model.RulesEngineBehaviorString](docs/RulesEngineBehaviorString.md)
