...
namespace edgefirewall.Model
{
    ...
    /// RuleSetResultAll
    /// </summary>
    [DataContract(Name = "RuleSetResultAll")]
    public partial class RuleSetResultAll : IEquatable<RuleSetResultAll>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RuleSetResultAll" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as RuleSetResultAll);
        }

        /// <summary>
        /// Returns true if RuleSetResultAll instances are equal
        /// </summary>
        /// <param name="input">Instance of RuleSetResultAll to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RuleSetResultAll input)
        {
            if (input == null)
            {
                return false;
