...
namespace domains.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DomainEntityResponse")]
    public partial class DomainEntityResponse : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainEntityResponse" /> class.
        /// </summary>
        ...
        public DomainEntityResponse(string name = default(string), List<string> cnames = default(List<string>), bool cnameAccessOnly = default(bool), bool isActive = default(bool), long edgeApplicationId = default(long), long digitalCertificateId = default(long), VarEnvironmentEnum? varEnvironment = default(VarEnvironmentEnum?), bool isMtlsEnabled = default(bool), long? mtlsTrustedCaCertificateId = default(long?), long? edgeFirewallId = default(long?), MtlsVerificationEnum? mtlsVerification = default(MtlsVerificationEnum?), List<long> crlList = default(List<long>), long id = default(long), string domainName = default(string))
        {
            this.Name = name;
            this.Cnames = cnames;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // DigitalCertificateId (long) maximum
            if (this.DigitalCertificateId > (long)-8446744073709551616)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DigitalCertificateId, must be a value less than or equal to -8446744073709551616.", new [] { "DigitalCertificateId" });
            }

            // DigitalCertificateId (long) minimum
            if (this.DigitalCertificateId < (long)1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DigitalCertificateId, must be a value greater than or equal to 1.", new [] { "DigitalCertificateId" });
            }
