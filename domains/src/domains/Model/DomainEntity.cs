...
namespace domains.Model
{
    ...
    public partial class DomainEntity : IValidatableObject
    {
        ...
        public DomainEntity(string name = default(string), List<string> cnames = default(List<string>), bool cnameAccessOnly = default(bool), bool isActive = default(bool), long edgeApplicationId = default(long), string digitalCertificateId = default(string), VarEnvironmentEnum? varEnvironment = default(VarEnvironmentEnum?), bool isMtlsEnabled = default(bool), long? mtlsTrustedCaCertificateId = default(long?), long? edgeFirewallId = default(long?), MtlsVerificationEnum? mtlsVerification = default(MtlsVerificationEnum?), List<long> crlList = default(List<long>), long id = default(long), string domainName = default(string))
        {
            this.Name = name;
            this.Cnames = cnames;
