...
namespace domains.Model
{
    ...
    /// DomainDataResponse
    /// </summary>
    [DataContract(Name = "DomainDataResponse")]
    public partial class DomainDataResponse : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainDataResponse" /> class.
        /// </summary>
        ...
        public DomainDataResponse(string name = default(string), List<string> cnames = default(List<string>), bool cnameAccessOnly = default(bool), bool isActive = default(bool), long edgeApplicationId = default(long), long digitalCertificateId = default(long), VarEnvironmentEnum? varEnvironment = default(VarEnvironmentEnum?), bool isMtlsEnabled = default(bool), long? mtlsTrustedCaCertificateId = default(long?), long? edgeFirewallId = default(long?), MtlsVerificationEnum? mtlsVerification = default(MtlsVerificationEnum?), List<long> crlList = default(List<long>))
        {
            this.Name = name;
            this.Cnames = cnames;
