...
namespace services.Api
{
    ...
    public interface IDefaultApiSync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ResourceResponseWithTotal</returns>
        ResourceResponseWithTotal GetResources(long serviceId, long? page = default(long?), long? pageSize = default(long?), string filter = default(string), string orderBy = default(string), string sort = default(string), int operationIndex = 0);
        ...
        /// <param name="sort"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ResourceResponseWithTotal</returns>
        ApiResponse<ResourceResponseWithTotal> GetResourcesWithHttpInfo(long serviceId, long? page = default(long?), long? pageSize = default(long?), string filter = default(string), string orderBy = default(string), string sort = default(string), int operationIndex = 0);
        /// <summary>
    ...
    public interface IDefaultApiAsync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ResourceResponseWithTotal</returns>
        System.Threading.Tasks.Task<ResourceResponseWithTotal> GetResourcesAsync(long serviceId, long? page = default(long?), long? pageSize = default(long?), string filter = default(string), string orderBy = default(string), string sort = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ResourceResponseWithTotal)</returns>
        System.Threading.Tasks.Task<ApiResponse<ResourceResponseWithTotal>> GetResourcesWithHttpInfoAsync(long serviceId, long? page = default(long?), long? pageSize = default(long?), string filter = default(string), string orderBy = default(string), string sort = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Return Service by ID
        /// </summary>
        /// <remarks>
    ...
    public partial class DefaultApi : IDefaultApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ResourceResponseWithTotal</returns>
        public ResourceResponseWithTotal GetResources(long serviceId, long? page = default(long?), long? pageSize = default(long?), string filter = default(string), string orderBy = default(string), string sort = default(string), int operationIndex = 0)
        {
            services.Client.ApiResponse<ResourceResponseWithTotal> localVarResponse = GetResourcesWithHttpInfo(serviceId, page, pageSize, filter, orderBy, sort);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ResourceResponseWithTotal</returns>
        public services.Client.ApiResponse<ResourceResponseWithTotal> GetResourcesWithHttpInfo(long serviceId, long? page = default(long?), long? pageSize = default(long?), string filter = default(string), string orderBy = default(string), string sort = default(string), int operationIndex = 0)
        {
            services.Client.RequestOptions localVarRequestOptions = new services.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ResourceResponseWithTotal>("/edge_services/{serviceId}/resources", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ResourceResponseWithTotal</returns>
        public async System.Threading.Tasks.Task<ResourceResponseWithTotal> GetResourcesAsync(long serviceId, long? page = default(long?), long? pageSize = default(long?), string filter = default(string), string orderBy = default(string), string sort = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            services.Client.ApiResponse<ResourceResponseWithTotal> localVarResponse = await GetResourcesWithHttpInfoAsync(serviceId, page, pageSize, filter, orderBy, sort, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ResourceResponseWithTotal)</returns>
        public async System.Threading.Tasks.Task<services.Client.ApiResponse<ResourceResponseWithTotal>> GetResourcesWithHttpInfoAsync(long serviceId, long? page = default(long?), long? pageSize = default(long?), string filter = default(string), string orderBy = default(string), string sort = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ResourceResponseWithTotal>("/edge_services/{serviceId}/resources", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
