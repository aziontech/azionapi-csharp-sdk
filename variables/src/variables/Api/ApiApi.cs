...
namespace variables.Api
{
    ...
    public interface IApiApiSync : IApiAccessor
    {
        ...
        Dictionary<string, Object> ApiSchemaRetrieve(string format = default(string), string lang = default(string), int operationIndex = 0);
        ...
        ApiResponse<Dictionary<string, Object>> ApiSchemaRetrieveWithHttpInfo(string format = default(string), string lang = default(string), int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public interface IApiApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Dictionary<string, Object>> ApiSchemaRetrieveAsync(string format = default(string), string lang = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Dictionary<string, Object>>> ApiSchemaRetrieveWithHttpInfoAsync(string format = default(string), string lang = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class ApiApi : IApiApi
    {
        ...
        /// <returns></returns>
        public ApiApi(variables.Client.Configuration configuration)
        {
        ...
        public ApiApi(variables.Client.ISynchronousClient client, variables.Client.IAsynchronousClient asyncClient, variables.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Dictionary&lt;string, Object&gt;</returns>
        public Dictionary<string, Object> ApiSchemaRetrieve(string format = default(string), string lang = default(string), int operationIndex = 0)
        {
            variables.Client.ApiResponse<Dictionary<string, Object>> localVarResponse = ApiSchemaRetrieveWithHttpInfo(format, lang);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Dictionary&lt;string, Object&gt;</returns>
        public variables.Client.ApiResponse<Dictionary<string, Object>> ApiSchemaRetrieveWithHttpInfo(string format = default(string), string lang = default(string), int operationIndex = 0)
        {
            ...
            if (format != null)
            {
                localVarRequestOptions.QueryParameters.Add(variables.Client.ClientUtils.ParameterToMultiMap("", "format", format));
            }
            if (lang != null)
            {
                localVarRequestOptions.QueryParameters.Add(variables.Client.ClientUtils.ParameterToMultiMap("", "lang", lang));
            }

            localVarRequestOptions.Operation = "ApiApi.ApiSchemaRetrieve";
            ...
            var localVarResponse = this.Client.Get<Dictionary<string, Object>>("/api/schema", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ApiSchemaRetrieve", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Dictionary&lt;string, Object&gt;</returns>
        public async System.Threading.Tasks.Task<Dictionary<string, Object>> ApiSchemaRetrieveAsync(string format = default(string), string lang = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            variables.Client.ApiResponse<Dictionary<string, Object>> localVarResponse = await ApiSchemaRetrieveWithHttpInfoAsync(format, lang, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Dictionary&lt;string, Object&gt;)</returns>
        public async System.Threading.Tasks.Task<variables.Client.ApiResponse<Dictionary<string, Object>>> ApiSchemaRetrieveWithHttpInfoAsync(string format = default(string), string lang = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Dictionary<string, Object>>("/api/schema", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public variables.Client.ApiResponse<VariableGet> ApiVariablesCreateWithHttpInfo(VariableCreate variableCreate, int operationIndex = 0)
        {
            ...
            {
                throw new variables.Client.ApiException(400, "Missing required parameter 'variableCreate' when calling ApiApi->ApiVariablesCreate");
            }
            ...
            localVarRequestOptions.Operation = "ApiApi.ApiVariablesCreate";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        public variables.Client.ApiResponse<Object> ApiVariablesDestroyWithHttpInfo(string uuid, int operationIndex = 0)
        {
            ...
            if (uuid == null)
            {
                throw new variables.Client.ApiException(400, "Missing required parameter 'uuid' when calling ApiApi->ApiVariablesDestroy");
            }
            ...
            localVarRequestOptions.Operation = "ApiApi.ApiVariablesDestroy";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        public variables.Client.ApiResponse<List<Variable>> ApiVariablesListWithHttpInfo(int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "ApiApi.ApiVariablesList";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        public variables.Client.ApiResponse<Variable> ApiVariablesRetrieveWithHttpInfo(string uuid, int operationIndex = 0)
        {
            ...
            if (uuid == null)
            {
                throw new variables.Client.ApiException(400, "Missing required parameter 'uuid' when calling ApiApi->ApiVariablesRetrieve");
            }
            ...
            localVarRequestOptions.Operation = "ApiApi.ApiVariablesRetrieve";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        public variables.Client.ApiResponse<VariableGet> ApiVariablesUpdateWithHttpInfo(string uuid, VariableCreate variableCreate, int operationIndex = 0)
        {
            ...
            if (uuid == null)
            {
                throw new variables.Client.ApiException(400, "Missing required parameter 'uuid' when calling ApiApi->ApiVariablesUpdate");
            }

            // verify the required parameter 'variableCreate' is set
            if (variableCreate == null)
            {
                throw new variables.Client.ApiException(400, "Missing required parameter 'variableCreate' when calling ApiApi->ApiVariablesUpdate");
            }
            ...
            localVarRequestOptions.Operation = "ApiApi.ApiVariablesUpdate";
            localVarRequestOptions.OperationIndex = operationIndex;
