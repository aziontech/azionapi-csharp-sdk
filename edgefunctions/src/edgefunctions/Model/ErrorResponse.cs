...
namespace edgefunctions.Model
{
    ...
    public partial class ErrorResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ErrorResponse(Option<string?> detail = default)
        {
            DetailOption = detail;
            OnCreated();
        }
    ...
    public class ErrorResponseJsonConverter : JsonConverter<ErrorResponse>
    {
        ...
        public override ErrorResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (detail.IsSet && detail.Value == null)
                throw new ArgumentNullException(nameof(detail), "Property is not nullable for class ErrorResponse.");
        ...
        {
            if (errorResponse.DetailOption.IsSet && errorResponse.Detail == null)
                throw new ArgumentNullException(nameof(errorResponse.Detail), "Property is required for class ErrorResponse.");

            if (errorResponse.DetailOption.IsSet)
                writer.WriteString("detail", errorResponse.Detail);
        }
    }
}
