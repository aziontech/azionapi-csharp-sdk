...
namespace edgefunctions.Model
{
    ...
    public partial class Results : IEquatable<Results>, IValidatableObject
    {
        ...
        public Results(long id = default(long), string name = default(string), string language = default(string), string code = default(string), Object jsonArgs = default(Object), string functionToRun = default(string), string initiatorType = default(string), bool active = default(bool), string lastEditor = default(string), string modified = default(string), long referenceCount = default(long))
        {
            this.Id = id;
            this.Name = name;
