...
namespace edgefunctions.Model
{
    ...
    public partial class PutEdgeFunctionRequest : IEquatable<PutEdgeFunctionRequest>, IValidatableObject
    {
        ...
        public PutEdgeFunctionRequest(string name = default(string), string code = default(string), Object jsonArgs = default(Object), bool active = default(bool), string initiatorType = default(string), string language = default(string))
        {
            this.Name = name;
            this.Code = code;
