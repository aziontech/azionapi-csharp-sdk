...
[assembly: InternalsVisibleTo("edgefunctions.Test")]
...
namespace edgefunctions.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is CreateEdgeFunctionRequest.InitiatorTypeEnum createEdgeFunctionRequestInitiatorTypeEnum)
                return CreateEdgeFunctionRequest.InitiatorTypeEnumToJsonValue(createEdgeFunctionRequestInitiatorTypeEnum);
            if (obj is PutEdgeFunctionRequest.InitiatorTypeEnum putEdgeFunctionRequestInitiatorTypeEnum)
                return PutEdgeFunctionRequest.InitiatorTypeEnumToJsonValue(putEdgeFunctionRequestInitiatorTypeEnum);
        ...
        /// </summary>
        public const string BASE_ADDRESS = "https://api.azionapi.net";
        ...
        /// The host of the API
        /// </summary>
        public const string HOST = "api.azionapi.net";
